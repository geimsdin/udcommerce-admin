...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        \Illuminate\Support\Facades\DB::statement('UPDATE orders SET shipping_address_id = address_id, billing_address_id = address_id WHERE address_id IS NOT NULL');
    ...
    public function down(): void
    {
        ...
        \Illuminate\Support\Facades\DB::statement('UPDATE orders SET address_id = shipping_address_id WHERE shipping_address_id IS NOT NULL');
